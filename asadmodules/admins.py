...
bttn = InlineKeyboardMarkup(
    [[InlineKeyboardButton("🔙 ɢᴏ ᴀᴄᴋ", callback_data="cbmenu")]]
)
...
┣★ ᴀᴅᴍɪɴ : At [{BOT_NAME}](t.me/L_0_O_R_D) ʀᴇғʀᴇsʜᴇᴅ
...
async def skip(client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("- Java .️", url=f"https://t.me/DEV_AH8"),
                InlineKeyboardButton("- Channel .", url=f"https://t.me/L_0_O_R_D"),
            ]
        ]
    )
    ...
    if len(m.command) < 2:
        ...
        if op == 0:
            ...
            await m.reply("✅ قوائم **الإنتظار فارغه.**\n\n**• توقف [تشغيل الموسيقى](t.me/L_0_O_R_D) وترك الحساب المساعد المحادثه الصوتيه**")
        elif op == 2:
...
async def stop(client, m: Message):
    ...
    if chat_id in QUEUE:
        try:
            ...
            clear_queue(chat_id)
            await m.reply("✅ **تم ايقاف** [تشغيل](t.me/DEV_AH8) **الموسيقي في المجموعه**")
            keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("- Java .️", url=f"https://t.me/DEV_AH8"),
...
async def resume(client, m: Message):
    ...
    if chat_id in QUEUE:
        try:
            ...
            await m.reply(
                "▶️ **At** [تشغيل الموسيقى](t.me/L_0_O_R_D) **Tʀᴀᴄᴋ ɪs ʀᴇsᴜᴍᴇᴅ.**\n\n• **To pause the stream, use the**\n» /pause command."
            )
            keyboard = InlineKeyboardMarkup(
        [
            [
