...
┣★ ᴀᴅᴍɪɴ : At [{BOT_NAME}](t.me/Akja0) ʀᴇғʀᴇsʜᴇᴅ
...
async def skip(client, m: Message):
    ...
    if len(m.command) < 2:
        ...
        if op == 0:
            ...
            await m.reply("✅ قوائم **الإنتظار فارغه.**\n\n**• توقف [تشغيل الموسيقى](t.me/Akja0) وترك الحساب المساعد المحادثه الصوتيه**")
        elif op == 2:
...
async def stop(client, m: Message):
    ...
    if chat_id in QUEUE:
        try:
            ...
            clear_queue(chat_id)
            await m.reply("✅ **تم ايقاف** [تشغيل](t.me/JAI6H) **الموسيقي في المجموعه**")
            keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("- Java .️", url=f"https://t.me/JAI6H"),
...
async def resume(client, m: Message):
    ...
    if chat_id in QUEUE:
        try:
            ...
            await m.reply(
                "▶️ **At** [تشغيل الموسيقى](t.me/Akja0) **Tʀᴀᴄᴋ ɪs ʀᴇsᴜᴍᴇᴅ.**\n\n• **To pause the stream, use the**\n» /pause command."
            )
            keyboard = InlineKeyboardMarkup(
        [
            [
