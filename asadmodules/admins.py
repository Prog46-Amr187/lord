...
┣★ ᴀᴅᴍɪɴ : ᴀᴛ [{BOT_NAME}](t.me/roottuxido) ʀᴇғʀᴇsʜᴇᴅ
...
async def skip(client, m: Message):
    ...
    if len(m.command) < 2:
        ...
        if op == 0:
            await m.reply("❌ **ᴀᴛ [playing music](t.me/libcubehawk) Nothing is currently playing**")
        elif op == 1:
            await m.reply("✅ __Queues__ **ɪs ᴇᴍᴘᴛʏ.**\n\n**• Stopped [playing music](t.me/roottuxido) Userbot leaving voice chat**")
        elif op == 2:
