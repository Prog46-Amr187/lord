...
async def skip(client, m: Message):
    ...
    if len(m.command) < 2:
        ...
        if op == 0:
            await m.reply("❌ **ᴀᴛ [playing music](t.me/AKJA0) Nothing is currently playing**")
        elif op == 1:
...
async def stop(client, m: Message):
    ...
    if chat_id in QUEUE:
        try:
            ...
            clear_queue(chat_id)
            await m.reply("✅ **Stopped** [playing music](t.me/AKJA0) **in the group**")
            keyboard = InlineKeyboardMarkup(
        [
            [
...
async def mute(client, m: Message):
    ...
    if chat_id in QUEUE:
        try:
            ...
            await m.reply(
                "🔇 **ᴀᴛ** [playing music](t.me/AKJA0) **ᴜsᴇʀʙᴏᴛ ɪs ᴍᴜᴛᴇᴅ.**\n\n• **Tᴏ ᴜɴᴍᴜᴛᴇ ᴛʜᴇ ᴜsᴇʀʙᴏᴛ, ᴜsᴇ ᴛʜᴇ**\n» /unmute **ᴄᴏᴍᴍᴀɴᴅ**."
            )
            keyboard = InlineKeyboardMarkup(
        [
            [
